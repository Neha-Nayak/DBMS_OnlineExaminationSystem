...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Times New Roman', Times, serif;color:#fff !important">
    <div style="background-color: #78384f;height: 100%;">
            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        <input type="submit" name="submit" value="add 1 more question" style="height: 3vw;width: auto;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                        <input type="submit" name="submit1" value="Done" style="height: 3vw;width: auto;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                    </form>
                </center>
            </section>
        </section>
