...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Times New Roman', Times, serif;height:auto;color:#fff">
    <div id="main" style="background-color: #78384f;height: auto;color:#fff !important">
           ...
           <center>
            <section id="addq" style="display:none;">
                <form style="width: 30vw" method="post">
                        ...
                        <input type="submit" name="submit" value="submit" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
            ...
            <section id="delq" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <input type="submit" name="submit1" value="submit" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
            ...
            <section id="viewq" style="display:none;">
                <form style="margin: 1vw;width: 30vw" method="post">
                        ...
                        <label for="quizid">Quiz Id</label>
                        <input type="number" name="quizid" placeholder="enter quiz id" required><h7 onclick="score()" style="padding:0;color: #fff;font-size:1vw;text-decoration:underline">get Quiz ID</h7><br><br>
                        <input type="submit" name="submit2" value="submit" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
