...
<body style="margin:0;height: 100%;outline: none;color: #042A38 !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/bg_img.png);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Times New Roman', Times, serif;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
                ...
                <div id="getcode" style="display: initial">
                    <form method="POST">
                        ...
                        <div class="signin">
                            ...
                            <br><br>
                            <input name="submit" class="sub" type="submit" value="Get the Code" style="height: 3vw;width: 10vw;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                    </form><br><br>
                </div>
...
if (isset($_POST['submit'])) {
    if (isset($_POST['email1']) && isset($_POST['pass1']) && isset($_POST['cpass1'])) {
        ...
        $password = crypt($password, 'xyzxyz');
        $cpassword = mysqli_real_escape_string($conn, $_POST['cpass1']);
        $cpassword = crypt($cpassword, 'xyzxyz');
