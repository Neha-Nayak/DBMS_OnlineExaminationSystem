...
<style>
    ...
    #btn{
        height: 3vw;width: 10vw;font-family: 'Times New Roman', Times, serif;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;
    }
    table{
        width: 90vw;
        margin-left: 5vw;
...
<body style="margin: 0 !important;font-weight: bolder !important;font-family: 'Times New Roman', Times, serif;color: #fff">
    <div style="background-color: #78384f;height: auto;">
