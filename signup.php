...
<body style="margin: 0;padding: 0;outline: none;height: 100%;min-height: 100%;color: #042A38 !important">
    <div style="font-family: 'Times New Roman', Times, serif;margin: 0;padding: 0;background-color: #fff;height: 100%;width: 100%;padding-bottom: 5vw;background-image: url(images/bg_img.png);height: ;background-repeat: no-repeat;background-size:cover;">
        <center>
